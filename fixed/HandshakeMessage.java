...
public class HandshakeMessage extends Properties {
     ...
     *
     * Use the built-in encoding of Properties as XML: - Encode the message in XML -
    ...
    public void send(Socket socket) throws IOException {
        ...
        String comment = "From " + InetAddress.getLocalHost() + ":" + socket.getLocalPort() + " to "
     ...
     *
     * First read a string with an integer followed by whitespace, which gives the
     * size of the message in bytes. Then read the XML data and convert it to a
     * HandshakeMessage.
     */
